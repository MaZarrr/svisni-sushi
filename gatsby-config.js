...
module.exports = {
  siteMetadata: {
    ...
    title: `СвисниБар`,
    description: `Закажите роллы, пиццу и суши в Уразово в службе Свисни Суши. 
    Доставка по Валуйкам, на дом, приятные цены, именинникам скидки. Телефон 8-904-094-92-22`,
    author: `@mazarrr`,
  },
  plugins: [
