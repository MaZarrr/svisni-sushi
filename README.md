...
-----------------
  ...
  flags: {
   ...
   "@fortawesome/fontawesome-svg-core": "^1.2.36",
    ...
    -> createRestaraunt -> создается ресторан на бэке, на фронте(клиент) выбирается ресторан если у Бизнеса их более 1.
    Клиент выбирает ресторан для дальнейшего распределения заказов клиентов по разным ресторанам бизнеса.
    -> 