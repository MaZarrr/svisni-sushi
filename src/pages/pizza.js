...
//                             const {id, name, idLargePizza = null,
//                                 slug, description,
//                                 price, weight, mass = weight, priceIn33cm,
//                                 count, total = price, ingrideents, sostav,
//                                 image: {fluid}, contentful_id, priceDef = price, size={[slug]: true,
//                                 }} = products
//                             // const idPizza = R.defaultTo(id, idLargePizza)
//                             return (
...
//                                         </CardMedia>
//                                         <SplitButton id={id} pizzaIng={visibleItems} ingrideents={ingrideents} sostav={sostav}/>
//                                         <CardContent>
                           ...
                           <Grid itemScope itemProp="itemListElement" itemType="http://schema.org/Product"
                               ...
                               <Card className={classes.card}>
                                   ...
                                   <CardMedia
                                    ...
                                    <SplitButton id={id} pizzaIng={updatePizza} ingrideents={ingrideents} sostav={sostav} />
                                   <CardContent>
                                       <Typography itemProp="description"
                                                   className={classes.deckript}
                                                   variant="caption"
