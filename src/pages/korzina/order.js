...
const city = {
  ...
  dvyl: {id: 2, priceDel: 200, deliverySalePrice: 1400, name: "Двулучное"},
  ...
  znamenk: {id: 10, priceDel: 150, deliverySalePrice: 900, name: "Знаменка"},
  loga: {id: 11, priceDel: 300, deliverySalePrice: 1800, name: "Логачевка"},
  kyky: {id: 12, priceDel: 300, deliverySalePrice: 1500, name: "Кукуевка"},
  kolos: {id: 13, priceDel: 650, deliverySalePrice: 3300, name: "Колосково"},
  kazink: {id: 14, priceDel: 600, deliverySalePrice: 3200, name: "Казинка"},
  ...
  valsoshgor: {id: 18, priceDel: 350, deliverySalePrice: 1700, name: "Валуйки(соц.городок)"},
  valrazdol: {id: 19, priceDel: 350, deliverySalePrice: 1700, name: "Валуйки(раздолье)"},
  togobi: {id: 20, priceDel: 150, deliverySalePrice: 800, name: "Тогобиевка"},
  novopetr: {id: 21, priceDel: 550, deliverySalePrice: 3300, name: "Новопетровка"},
  babki: {id: 22, priceDel: 350, deliverySalePrice: 1700, name: "Бабки"},
  syxarevo: {id: 23, priceDel: 250, deliverySalePrice: 1400, name: "Сухарево"},
  tatarievka: {id: 24, priceDel: 100, deliverySalePrice: 1000, name: "Татариевка"},
  pricten: {id: 25, priceDel: 300, deliverySalePrice: 1500, name: "Пристень"},
  lobkovka: {id: 26, priceDel: 250, deliverySalePrice: 1100, name: "Лобковка"},
  nasonovo: {id: 27, priceDel: 650, deliverySalePrice: 3900 , name: "Насоново"},
  yablonovo: {id: 28, priceDel: 600, deliverySalePrice: 2900 , name: "Яблоново"},
  valsim: {id: 29, priceDel: 400, deliverySalePrice: 1900, name: "Валуйки(Нов.Симоновка)"},
  valsovhoz: {id: 30, priceDel: 500, deliverySalePrice: 1900, name: "Валуйки(совхоз)"},
  valkordon: {id: 31, priceDel: 500, deliverySalePrice: 1800, name: "Валуйки(байрацкий.корд)"},
  hrapovo: {id: 32, priceDel: 350, deliverySalePrice: 2000, name: "Храпово"},
  zerdevk: {id: 33, priceDel: 200, deliverySalePrice: 900, name: "Жердевка"},
  yraevo: {id: 34, priceDel: 350, deliverySalePrice: 2000, name: "Ураево"},
