...
return (
  ...
  Наше меню порадует широким выбором, низкими ценами а также уникальными роллами!"
  />
      {/*Официальный сайт Империи суши в Новосибирске. Бесплатная и быстрая доставка на дом. */}
      {/*Суши, роллы, сеты, гунканы на заказ. Меню. Низкие цены. Тел.: 8(800) 500-04-09 */}
