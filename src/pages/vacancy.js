                ...
                <Container>
                    ...
                    <Card key={1} raised style={{ margin: `8px 0` }}>
                                ...
                                <ul>
                                    ...
                                    <li>Частота выплат: каждый день, 2500-5000 рублей смена</li>
                                </ul>
                    ...
                    <Card key={2} raised style={{ margin: `8px 0` }}>
                                ...
                                <ul>
                                    ...
                                    <li>Частота выплат: за смену или один в неделю</li>
                                    <li>Оплата 1500-2500 рублей смена</li>
                    ...
                    <Card key={3} raised style={{ margin: `8px 0` }}>
                                ...
                                <Typography variant='h4'>Условия</Typography>
                                <ul>
                                    <li>Заработная плата 2200-5000 смена</li>
                                    <li>Частота выплат: За смену или один раз в неделю</li>
                    ...
                    <Card key={4} raised style={{ margin: `8px 0` }}>
                                ...
                                <ul>
                                    ...
                                    <li>Заработная плата 1500-2000 рублей смена</li>
                                    <li>Частота выплат: За смену или один раз в неделю</li>
                                    <li>Официальное оформление</li>
                                </ul>
                                <Typography variant='h4'>Место работы</Typography>
