            ...
            { prod === true ? '' :
                ...
                <Hidden smUp>
                    <SwipeableViews style={styles.root} slideStyle={styles.slideContainer}>
                        ...
                        <Typography className={classesCard.titleIndex} variant={"h2"}>{isNil(indexProduct[0].node.title) ? "" : indexProduct[1].node.title}</Typography>
                        {/*</div>*/}
                        <SwipeableViews style={styles.root} slideStyle={styles.slideContainer}>
                            { isNil(indexProduct[0].node.new) ? '' :  indexProduct[1].node.new.map((homeProduct) => (
